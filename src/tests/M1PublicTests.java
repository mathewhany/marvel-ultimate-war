...
public class M1PublicTests {
    ...
    public void testChampionsSameMaxHP()
        ...
        if (champions != null && actualChampions != null) {
            for (int i = 0; i < champions.size(); i++) {
                Object d1f = f1.get(champions.get(i));
                Object d2f = f1.get(actualChampions.get(i));
                if (!d1f.equals(d2f)) {
                    sameHP = false;
                }
            }
    ...
    public void testAbilitiesSameName()
        ...
        if (abilities != null && actualAbilities != null) {
            for (int i = 0; i < abilities.size(); i++) {
                Object d1f = f1.get(abilities.get(i));
                Object d2f = f1.get(actualAbilities.get(i));
                if (!d1f.equals(d2f)) {
                    sameName = false;
                }
            }
        ...
        if (abilities != null && actualAbilities != null) {
            for (int i = 0; i < abilities.size(); i++) {
                ...
                if (d1f.getClass().equals(Class.forName(ccAbilitiesPath))) {
                    ...
                    Object d11f = f6.get(d1f);
                    Object d12f = f6.get(d2f);
                    ...
                    Object d15f = f8.get(d11f);
                    Object d16f = f8.get(d12f);
                    ...
                    Object d17f = f9.get(d11f);
                    Object d18f = f9.get(d12f);
                    ...
                    Object d19f = f10.get(d11f);
                    Object d20f = f10.get(d12f);
    ...
    private boolean checkAbilitiesEqual(Object a1, Object a2) throws Exception {
        ...
        Field f1 = Class.forName(abilitiesPath).getDeclaredField("name");
        f1.setAccessible(true);
        Object d1f = f1.get(a1);
        Object d2f = f1.get(a2);
        if (!d1f.equals(d2f)) {
            return false;
        }
        Field f2 = Class.forName(abilitiesPath).getDeclaredField("manaCost");
        f2.setAccessible(true);
        Object d3f = f2.get(a1);
        Object d4f = f2.get(a2);
        if (!d3f.equals(d4f)) {
            return false;
        }
        ...
        Object d5f = f3.get(a1);
        Object d6f = f3.get(a2);
        if (!d5f.equals(d6f)) {
            return false;
        }
        ...
        Object d7f = f4.get(a1);
        Object d8f = f4.get(a2);
        if (!d7f.equals(d8f)) {
            return false;
        }
        ...
        Object d9f = f5.get(a1);
        Object d10f = f5.get(a2);
        if (!d9f.equals(d10f)) {
        ...
        if (a1.getClass().equals(Class.forName(dmgPath))) {
            Field f6 = Class.forName(dmgPath).getDeclaredField("damageAmount");
            f6.setAccessible(true);
            Object d11f = f6.get(a1);
            Object d12f = f6.get(a2);
            if (!d11f.equals(d12f)) {
                return false;
            }
        ...
        Object d13f = f7.get(a1);
        Object d14f = f7.get(a2);
        return d13f.equals(d14f);
